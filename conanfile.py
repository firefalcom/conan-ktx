...
class KtxConan(ConanFile):
    ...
    def _requires_tools(self):
        return self.settings.os not in ["iOS", "Android", "Emscripten", "Switch", "Orbis", "Prospero"] and self.options.tools
    ...
    def generate(self):
        ...
        tc.variables["KTX_FEATURE_TOOLS"] = self._requires_tools
        tc.variables["KTX_FEATURE_DOC"] = False
        tc.variables["KTX_FEATURE_VK_UPLOAD"] = False
        tc.variables["KTX_FEATURE_GL_UPLOAD"] = False
    ...
    def package_info(self):
        ...
        if self._requires_tools:
            ...
            self.cpp_info.components["libktx"].libs = ["ktx_read"]

        self.cpp_info.components["libktx"].defines = [
            "KTX_FEATURE_KTX1", "KTX_FEATURE_KTX2"
        ]
